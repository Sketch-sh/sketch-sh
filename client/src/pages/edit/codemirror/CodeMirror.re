...
module LintOptions = {
  ...
  type cb = array(annotation) => unit;

  [@bs.deriving abstract]
  type lintOptions = {
    getAnnotations: (. string, cb) => unit,
    async: bool,
  };
  type t = lintOptions;
  let make = lintOptions;
};
...
module EditorConfiguration = {
  ...
  type editorConfiguration = {
    ...
    */
    ...
    lint: bool,
    [@bs.as "lint"] [@bs.optional]
    lintOptions: LintOptions.t,
  };
  ...
  */
  ...
  external addLineClass:
    (
      t,
      ~line: int,
      ~where: [@bs.string] [ | `text | `background | `wrap],
      ~className: string
    ) =>
    LineHandle.t =
    "addLineClass";
  ...
  [@bs.send]
  external addLineClassWithHandle:
    (
      t,
      ~line: LineHandle.t,
      ~where: [@bs.string] [ | `text | `background | `wrap],
  ...
  external removeLineClass:
    ...
    "removeLineClass";
  [@bs.send]
  external removeLineClassWithHandle:
    (
      t,
      ~line: LineHandle.t,
      ~where: [@bs.string] [ | `text | `background | `wrap],
