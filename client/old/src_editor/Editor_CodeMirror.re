...
external convertRef: ReactDOMRe.domRef => callbackDomRef = "%identity";
// external convertRef: ReactDOMRe.domRef => Js.nullable(Dom.element) =
//   "%identity";
...
let make =
  ...
  render: ({handle, state: _}) =>
    <div ?className ref={Obj.magic(handle(setDivRef))} />,
};
